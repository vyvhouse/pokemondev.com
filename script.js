const translations = {
  ko: {
    ...
    language: { aria: '언어 선택' },
    nav: { aria: '상단 내비게이션', homeAria: 'PokemonDev 홈', event: 'EVENT', demo: 'DEMO', fix: 'THE FIX', status: 'STATUS', items: 'ITEMS', join: 'JOIN' },
    hero: {
      shout: 'AI는 강하다. 하지만 벽은 더 강했다.',
      cta: { pass: 'Request Pass', watch: 'Watch the run' },
      status: { kicker: 'TRAINER PASS', title: 'Run slot command', countdown: 'T-8 days · limited trainer slots', countdownShort: 'T-8 days', slots: 'Limited trainer slots', hashed: 'Hashed-backed agent harness sprint.' },
      menuAria: '배틀 커맨드',
  ...
  ja: {
    ...
    nav: { aria: '上部ナビゲーション', homeAria: 'PokemonDev ホーム', event: 'EVENT', demo: 'DEMO', fix: 'THE FIX', status: 'STATUS', items: 'ITEMS', join: 'JOIN' },
    hero: { shout: 'AIは強い。でも壁はもっと強かった。', cta: { pass: 'Request Pass', watch: 'Watch the run' }, status: { kicker: 'TRAINER PASS', title: 'Run slot command', countdown: 'T-8 days · limited trainer slots', countdownShort: 'T-8 days', slots: 'Limited trainer slots', hashed: 'Hashed-backed agent harness sprint.' }, menuAria: 'バトルコマンド', menu: { fight: 'FIGHT', dex: 'DEX', bag: 'BAG', join: 'JOIN' }, videoAria: 'AIのポケモンプレイ動画', videoGbaAria: 'GBA内のAIポケモンプレイ動画', mobileCalloutAria: 'AIハーネス案内', mobileCallout: 'AIハーネスでポケモンを攻略しよう！', playerVideoAria: '左下のハーネス・バトル動画', playerVideoLabel: '左下のバトルコマンド動画', videoError: '動画ファイルを読み込めませんでした' },
